...
export default function KanyakumariPackage() {
  return (
    <div className="container" id="Kanyakumari" >
      {/* <h2 style={{textAlign:"center",marginTop:"100px" }} >Our Packages</h2> */}
      <h3>08.Kanyakumari To All Districts</h3>
      ...
      <Carousel>
        <Carousel.Item interval={3000}>
            ...
            <div className="col card"style={{margin:"30px"}}>
              ...
              <div>
                <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Chennai</h5>
            ...
            <div className="col card"style={{margin:"30px"}}>
              ...
              <div>
              <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Theni</h5>
                <h6>4 Days/3 Night</h6>
                <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
                <h2>Rs.7,000 /-</h2>
              </div>
            ...
            <div className="col card"style={{margin:"30px"}}>
              ...
              <div>
              <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Hogenakkal</h5>
                <h6>4 Days/3 Night</h6>
                <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
                <h2>Rs.10,000 /-</h2>
              </div>
              <h5> Time: 9 Hr 8 Min (551km)</h5>
              <div className="card-body row">
                <div className="col"><FontAwesomeIcon icon={faUtensils} /><br /> Food</div>
                <div className="col"><FontAwesomeIcon icon={faHotel} /><br /> Hotel</div>
                <div className="col"><FontAwesomeIcon icon={faVanShuttle} /><br /> Travel</div>          
        ...
        <Carousel.Item interval={3000}>
          <div className="row"style={{marginTop:"30px"}}>
            <div className="col card"style={{margin:"30px"}}>
              ...
              <div>
              <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Kumbakonam</h5>
                <h6>4 Days/3 Night</h6>
                <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
                <h2>Rs.8,000 /-</h2>
              </div>
            ...
            <div className="col card"style={{margin:"30px"}}>
              ...
              <div>
              <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Madurai</h5>
                <h6>4 Days/3 Night</h6>
                <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
                <h2>Rs.4,000 /-</h2>
              </div>
            ...
            <div className="col card"style={{margin:"30px"}}>
              ...
              <div>
              <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Ooty</h5>
                <h6>4 Days/3 Night</h6>
                <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
                <h2>Rs.26,000 /-</h2>
              </div>
        ...
        <Carousel.Item interval={3000}>
          ...
          <div className="col card"style={{margin:"30px"}}>
            ...
            <div>
            <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Rameshwaram</h5>
              <h6>4 Days/3 Night</h6>
              <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
              <h2>Rs.6,000 /-</h2>
            </div>
          ...
          <div className="col card"style={{margin:"30px"}}>
            ...
            <div>
            <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Kodaikanal</h5>
              <h6>4 Days/3 Night</h6>
              <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
              <h2>Rs.19,000 /-</h2>
            </div>
          ...
          <div className="col card"style={{margin:"30px"}}>
            ...
            <div>
            <h5><FontAwesomeIcon icon={faLocationDot} /> Kanyakumari-Yarcaud</h5>
              <h6>4 Days/3 Night</h6>
              <FaStar/><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/>
              <h2>Rs.8,999 /-</h2>
            </div>
